...
/* harmony export */   setForecastDate: () => (/* binding */ setForecastDate),
...
const getWeatherForecastPromiseChain = () => {
  getWeatherForecast()
    ...
    .then(_dom_js__WEBPACK_IMPORTED_MODULE_1__.setForecastDate);
};
