      ...
      /***/ (module, __webpack_exports__, __webpack_require__) => {
        ...
        var ___CSS_LOADER_URL_IMPORT_0___ = new URL(
          /* asset import */ __webpack_require__(
            /*! ../src/images/background-image.jpeg */ "./src/images/background-image.jpeg"
          ),
          __webpack_require__.b
        );
        var ___CSS_LOADER_URL_IMPORT_1___ = new URL(
          /* asset import */ __webpack_require__(
            /*! ../src/images/background-nature-image.jpeg */ "./src/images/background-nature-image.jpeg"
          ),
          __webpack_require__.b
        );
...
*/
  ...
  \********************/
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ hideSearchError: () =>
            /* binding */ hideSearchError,
          /* harmony export */ setForecastDay: () =>
            /* binding */ setForecastDay,
          /* harmony export */ setForecastDescription: () =>
            /* binding */ setForecastDescription,
          /* harmony export */ setForecastIcon: () =>
            /* binding */ setForecastIcon,
          /* harmony export */ setForecastTempMaxAndMin: () =>
            /* binding */ setForecastTempMaxAndMin,
          /* harmony export */ setWeatherDetails: () =>
            /* binding */ setWeatherDetails,
          /* harmony export */ setWeatherPlaceAndCondition: () =>
            /* binding */ setWeatherPlaceAndCondition,
          /* harmony export */ setWeatherTime: () =>
            /* binding */ setWeatherTime,
          /* harmony export */ showSearchError: () =>
            /* binding */ showSearchError,
          /* harmony export */
        });
        // set weather time :
        ...
        const setWeatherPlaceAndCondition = (
          condition,
          icon,
          country,
          city
        ...
        const setForecastIcon = (desiredForecastData) => {
          const allForecastIcons = document.querySelectorAll(
        ...
        const setForecastTempMaxAndMin = (desiredForecastData) => {
          const allForecastMaxTemp =
            document.querySelectorAll(".forecast-temp-max");
          const allForecastMinTemp =
            document.querySelectorAll(".forecast-temp-min");
          [...allForecastMaxTemp].map((ele, index) => {
            const kelvinToCelsiusMaxTemp =
              desiredForecastData[index].temp_max - 273.15;
            ele.textContent = ` ${parseInt(kelvinToCelsiusMaxTemp)} °C`;
          });
          [...allForecastMinTemp].map((ele, index) => {
            const kelvinToCelsiusMinTemp =
              desiredForecastData[index].temp_min - 273.15;
  ...
  \**********************/
    ...
    const getWeatherDataPromiseChain = () => {
      getWeatherData()
        ...
        .then((desiredData) => {
          // set weather time :
          (0, _dom_js__WEBPACK_IMPORTED_MODULE_1__.setWeatherTime)(
            desiredData.localtime
          );
          // set weather place and condition
